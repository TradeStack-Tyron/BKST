...
// FIX: Removed unused 'Navigate' import to resolve TS6133 error.
import '../Homepage.css';
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-purple-200 sm:text-7xl">
              BKST
              <br />
              For Traders By Traders
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-purple-200 sm:text-xl/8">
              A minimalistic Back testing platform for Traders to test out their
              edge on the Market.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="/login"
                className="rounded-md bg-indigo-600 px-8.5 py-2.5 text-sm font-semibold text-purple shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Sign up
              </a>
            </div>
